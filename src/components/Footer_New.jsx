...
const Footer_New = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black text-white font-sans rounded-t-3xl">
      ...
      <div className="relative z-10 flex flex-col justify-between h-full p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between text-center sm:m-28 m-6">
          {/* Left Nav */}
          <div className="space-y-2 sm:text-start text-start sm:w-auto w-full">
          ...
          <div className="sm:text-left text-center max-w-xs w-full sm:mt-0 mt-6">
            ...
            <div className="border-b border-white flex items-center p-1">
              <input
                type="email"
                placeholder="Email address"
                className="bg-transparent outline-none w-full placeholder-gray-200 text-sm"
              />
        ...
        {/* Middle Title */}
        <div className="flex-grow min-h-0 flex items-center justify-center sm:mt-0 ">
          <h1 className="md:text-[20vw] text-[25vw] font-extrabold leading-none text-white/90">Jimmu</h1>
        </div>

        {/* Footer */}
        <div className="flex sm:flex-row flex-col justify-between text-xs items-center border-t border-white/10 pt-4 sm:px-6 px-4">
          <p className="text-center sm:text-left">
            © JIMMU. {new Date().getFullYear()}. All rights reserved. | Developed by{' '}
            <a href="https://webmindsdesigns.com/" className="hover:underline">WebMinds</a>
          </p>
          <p>{time}</p>
